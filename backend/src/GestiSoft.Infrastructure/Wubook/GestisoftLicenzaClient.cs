...
/// usato solo per l'intercettazione delle prenotazioni Wubook — vedi IGestisoftLicenzaClient.
...
/// (WubookEventiService) lo gestisce già come "nessun evento da elaborare", così un problema di
